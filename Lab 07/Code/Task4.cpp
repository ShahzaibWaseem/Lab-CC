...
int main(int argc, char const *argv[]){
    ...
    for (int i = 0; i < expression.length(); i++) {
        if (t->type == 'E') {
            ...
            case 2: // *,/
                n = new node; n->type = 'T'; nonTerminal++; t->next = n; n->prev = t; t = n;
            ...
            case 3: //id, num, or op
                ...
                n = new node; n->type = 'F'; nonTerminal++; t->next = n; n->prev = t; t = n;
    ...
    terminal=expression.length();
	cout << "Number of Terminal Nodes: " << terminal << "\n" << "Number of Non-Terminal Nodes: " << nonTerminal;
